   ...
   function goToFirstPage() {
    ...
    <div className='flex flex-col gap-4'>
        <div className="flex gap-3 items-center">
            ...
            <div className="px-3 w-72 py1.5 border border-white/10 rounded-lg flex items-center gap-3">
            <Search className="size-4 text-emerald-300"/>
                ...
                placeholder="Buscar participante..." type="text" />
            </div>
        ...
        <Table>
            <thead>
                ...
                <TableHeader style={{ width: 48}} >
                     <input type="checkbox" className='sizee-4 bg-black/20 rounded border border-white/10'/>
                     </TableHeader>
            ...
            <tbody>
               {attendees.map((attendee) => {
                return(
                    <TableRow key={attendee.createdAt}>
                    <TableCell >
                        <input type="checkbox" className='sizee-4 bg-black/20 rounded border border-white/1'/>
                    </TableCell>
